...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{
          \textbf{Key contributor} to the creation of \textbf{Radeon GPU Detective (RGD)} by spearheading the design and development of DirectX 12 and Vulkan driver components. \textbf{Adopted by major video game studios} to resolve GPU crashes in over six AAA titles, earning recognition with an ``Executive Spotlight'' award.
        }
      \resumeItemListEnd
    %== LANL ==============
    \resumeSubheading
