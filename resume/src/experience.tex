...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {C, C++, Rust, DirectX 12}{Graphics programming}
      \resumeItemListStart
        \resumeItem{
          Contributed to AMD's DirectX 12, Vulkan, and OpenCL drivers.
        }
        \resumeItem{
        ...
        \resumeItem{
          Designed and created an internal AMD package manager to aid with GPU driver engineer development.
        }
      \resumeItemListEnd
    \resumeSubheading
