...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{
          Designed an \textbf{award-winning} AMD graphics driver feature for capturing and analyzing certain GPU crashes (page faults and device hangs) -- used by multiple major video game studios to fix GPU bugs on over six AAA game titles
        }
        \resumeItem{
          Designed a new tracing and profiling system for AMD GPUs -- new system enables richer and broader GPU data collection and is significantly more robust, scalable, and extensible than the previous system
        }
        \resumeItem{
          Improved driver developer productivity by developing internal tooling for rapid graphics driver deployment, effectively eliminating the ``deploy'' stage in a ``build-deploy-test'' developer workflow
        }
      \resumeItemListEnd
    \resumeSubheading
